...
<div class="container-fluid">
    ...
    <div class="row" style="margin-left:0;margin-right:0;">
        ...
        <div class="jumbotron daftar">
            <div class="header">
                <h3><center>
               <marquee direction="left" scrollamount="15" align="center"><font"><h2 class="bg-black">Ini Adalah Halaman Formulir Calon Siswa/i</h2></font> </marquee>
                </center></h3>
            </div>
            <hr style="border:1px solid black">
            <form action="" method="post">
            <a href="https://wa.me/6283150842355"><img src="img/w.png" width="347" height="120" border="0" /></a><br />
                <div class="form-group">
                <label for="exampleInputEmail1">Nama Lengkap</div>
              </label>
            ...
            <div class="form-group">
                    <label for="exampleInputEmail1">Ukuran Jas</label>
            <select name="no_jaket" class="form-control" required>
                  <option value="0"> -- Pilih Ukuran Jas -- </option>
            ...
            <form action="ceklogin.php" method="post">
                ...
                <div class="form-group">
                  <p>
                    ...
                    <p align="center"><span class="style5"><a href="admin/login.php" class="style5">LOGIN ADMIN     </a></span></p>
                </div>
            </form>
        </div>
        </div>
